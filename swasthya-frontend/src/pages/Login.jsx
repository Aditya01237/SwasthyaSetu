...
const Login = () => {
  ...
  const handleSendOtp = async () => {
    try {
      ...
      console.error(err);
     alert(err.response?.data?.message || err.response?.data || err.message || "OTP failed");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white/[0.03] border border-white/[0.08] backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <p className="text-sm text-slate-500 text-center mt-1 mb-7">
              {isRegister ? "Create your patient account" : "Login to your patient portal"}
            </p>
            ...
            <AnimatePresence mode="wait">
              ...
              {isRegister && (
                ...
                >
                  {[
                    { label: "Full Name", placeholder: "Dr. John Doe", value: name, set: setName, type: "text" },
                    { label: "Age", placeholder: "25", value: age, set: setAge, type: "number" },
                    { label: "Phone", placeholder: "+91 98765 43210", value: phone, set: setPhone, type: "tel" },
                  ...
                  <button
                    ...
                    disabled={loading || !name || !age || !gender || !phone || !email}
                    className="w-full bg-gradient-to-r from-sky-500 to-blue-600 text-white py-3 rounded-xl font-medium text-sm
